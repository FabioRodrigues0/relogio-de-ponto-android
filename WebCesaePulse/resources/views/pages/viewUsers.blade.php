            ...
            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                ...
                <div class="card shadow-lg">
                    <div class="card-body p-5">
                        ...
                        <form method="POST" action="{{ route('update.contact') }}" class="needs-validation"
                            autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label class="mb-2 text-muted" for="name">Name</label>
                                <input id="name" type="name" class="form-control" name="name"
                                    value="{{ $ourUser->name }}" autofocus="" fdprocessedid="8f7bri" required>
                                @error('name')
                                    <div>
                                        Name is invalid!
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="email" type="email" class="form-control" name="email"
                                    value="{{ $ourUser->email }}" autofocus="" fdprocessedid="8f7bri" required>
                                @error('email')
                                    <div>
                                        Email is invalid!
                                    </div>
