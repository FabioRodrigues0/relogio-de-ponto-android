        ...
        <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-7 col-sm-9">
            ...
            <div class="card shadow-lg">
                <div class="card-body p-5">
                    ...
                    <form method="POST" action="{{ route('user.create') }}" class="needs-validation" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label class="mb-2 text-muted" for="name" >Name</label>
                            <input id="name" type="name" class="form-control" name="name" value="" autofocus="" fdprocessedid="8f7bri" required>
                            @error('name')
                                <div>
                                    Name is invalid!
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="email" type="email" class="form-control" name="email" value="" autofocus="" fdprocessedid="8f7bri" required>
                            @error('email')
                                <div>
                                    Email is invalid!
                                </div>
                        ...
                        <div class="mb-3">
                          ...
                          <select class="form-select form-select-m" aria-label="Small select example" required name ="users_type_id">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-m" aria-label="Small select example" name ="setor" required>
                                <option selected>-</option>
