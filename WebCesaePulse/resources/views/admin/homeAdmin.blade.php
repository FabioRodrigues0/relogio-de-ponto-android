...
@section('content')
                                    ...
                                    <div class="row gy-2 gx-3 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <select class="form-select" id="autoSizingSelect" name="attendance_mode">
                                                ...
                                                <option
                                                    value="1" {{ request()->query('attendance_mode') == '1' ? 'selected' : '' }}>
                                                    Remoto
                                                </option>
                                                <option
                                                    value="2" {{ request()->query('attendance_mode') == '2' ? 'selected' : '' }}>
                                                    Presencial
                                                </option>
                                            </select>
                                        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-6 d-flex justify-content-center">
            <div class="card mb-4 w-100 shadow">
                <div class="card-header fs-5 text-center"> Ranking desempenho Utilizadores -
                    Mês {{ $actualMonthYear }}</div>
                <div class="card-body table-responsive">
                    <table class="table table-striped">
                                    ...
                                    <div class="progress" style="height: 20px;">
                                        ...
                                        @if($punctuality >= 90)
                                            <div class="progress-bar bg-success" role="progressbar"
                                                 ...
                                                 aria-valuemax="100">{{ round($user->punctuality_percentage) }}%
                                            </div>
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-outline-dark" data-bs-toggle="modal"
                                        ...
                                        data-bs-whatever="@mdo">Enviar alertas
                                </button>
                            </li>
