...
@section('content')
                                ...
                                <a href="#alerts" class="no-link-style">
                                    <div class="card shadow card-alert">
                                        <div class="card-body text-center">
                                            <svg class="notification m-3" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50"
                                            style="fill:#FAB005;">
    ...
    <div class="row justify-content-center">
        <div class="col-6 d-flex justify-content-center">
            <div class="card mb-4 w-100 shadow">
                <div class="card-header fs-5 text-center"> Ranking horas mensais Utilizadores - Mês {{ $actualMonthYear }}</div>
                <div class="card-body table-responsive">
                    <table class="table table-striped">
                                    ...
                                    <div class="progress" style="height: 20px;">
                                        ...
                                        @elseif ($punctuality >= 50)
                                            <div class="progress-bar bg-warning" role="progressbar" style="width: {{ round($user->punctuality_percentage) }}%;"
                                                aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">{{ round($user->punctuality_percentage) }}%</div>
                                        @else
                                                 <div class="progress-bar bg-danger" role="progressbar" style="width: {{ round($user->punctuality_percentage) }}%;"
                                                aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">{{ round($user->punctuality_percentage) }}%</div>
                                        @endif
                    ...
                    <ul>
                        ...
                        @else
                            ...
                            <li class="d-flex justify-content-between align-items-center">
                                <span>
                                    Solicitação de alteração de palavra-passe pendente para o utilizador com o <b>ID {{ $alert->users_id }}.</b>
                                </span>
                                <form action="{{ route('admin.password', $alert->users_id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    <button type="submit" class="btn btn-sm btn-outline-success m-1">Concluído</button>
                                </form>
                            </li>
                            @endforeach
                        @endif
